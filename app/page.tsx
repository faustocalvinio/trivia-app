...
const Home:NextPage = () => {
    ...
    return (      
      <>
        ...
        <main className="min-h-[30vh] min-w-[1100px] bg-white relative flex flex-col  px-10 items-center justify-center border-2 border-black max-w-[1200px] mx-auto dark:bg-black max-sm:px-7 max-sm:min-w-0 max-sm:w-[90%] dark:border-white max-sm:py-4">   
