...
function App() {
    ...
    return (      
      <>
        ...
        <main className="min-h-[60vh] min-w-[1100px] relative flex flex-col  px-10 items-center justify-center border-2 border-blue-400 max-w-[1200px] mx-auto dark:bg-black max-sm:px-7 max-sm:w-[90%] dark:border-gray-600">   
